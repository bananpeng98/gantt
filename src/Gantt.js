...
function Gantt({ tasks, style }) {
  ...
  return (
      <svg id="gantt" viewBox={"0 0 " + width + " " + height} fontFamily="Arial">
        <g id="timeline" transform="translate(20, 20)">
          <path
            d={`m17,0
                ...
                a17,17 0 0 1 -17,-17
                v-1
                a17,17 0 0 1 17,-17 z`}
            fill={style.weekBarColor}
        ...
        <g id="tasks" transform={`translate(${padX}, ${padY})`}>
          {[...Array(weeks-1).keys()].map(week =>
                                          <rect
                                            key={week}
                                            transform="translate(198)"
                                            fill={style.weekNotchesColor}
                                            rx="2"
                                            width="2"
                                            height={graphHeight-taskBarHeight}
                                            x={48.8+week*49.5}
                                            y={topBarHeight}
                                          ></rect>
                                         )}
          {tasks.map((task, i) => <g key={i}>
                                    <text
                                      fontSize="16"
                                      name="Label"
                                      fill={style.taskTextColor}
                                      dy=".38em"
                                      textAnchor="start"
                                      fontWeight={task.type === 'task' ? 400 : 600}
                                      x={task.type === 'task' ? 10 : 0}
                                      y={48+i*48}
                               ...
                               <g>
                                 ...
                                 <g
                                   transform={`
                                      translate(
                                        ${sideBarWidth/2 + task.startRel*(graphWidth-padX)},
                                        ${topBarHeight + i*taskBarHeight})`}>
                                   {task.type === 'task'
                                    ? <path
                                        strokeWidth="0"
                                        ...
                                        d={`m 0 4
                                            a 4 4 0 0 1 4 -4
                                            h ${task.durationRel*graphWidth-8}
                                            a 4 4 0 0 1 4 4
                                            v 10
                                            a 4 4 0 0 1 -4 4
                                            h -${task.durationRel*graphWidth-8}
                                    ...
                                    : <path
                                        ...
                                        stroke="#000000"
                                    d={`m 0 0
                                        h ${task.durationRel*graphWidth}
                                        v 14
                                        l -5 -5
                                        h -${task.durationRel*graphWidth-10}
                                        l -5 5
                                        v -14 z`}
                                      ></path>}
                                 </g>
          ...
          {style.showNow ? <rect
                             fill="#ff8844"
                             transform={`translate(${sideBarWidth/2 + relNow*(graphWidth-padX)-1}, ${topBarHeight})`}
                             width="2"
                             height={graphHeight}
                           ></rect> : <></>}
        </g>
        <g
          id="legend"
          transform={`translate(${width-Object.keys(style.categories).length*120}, ${graphHeight+40})`}
        >
          {Object.keys(style.categories).map((cat, i) =>
                                             <g
                                               key={i}
                                               transform={`translate(${i*120})`}>
                                               <text
                                                 fontSize="16"
                                                 name="Label"
                                                 fill={style.taskTextColor}
                                               ...
                                               >{cat}</text>
                                               <path
                                                 fill={style.categories[cat]}
                                                 d={`m 0 4
                                                     a 4 4 0 0 1 4 -4
                                                     h 20
                                                     a 4 4 0 0 1 4 4
                                                     v 10 a 4 4 0 0 1 -4 4
